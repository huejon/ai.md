...
- 2026-06-30: User explicitly authorized cleanup of root `agents/`, `skills/`, `templates/`, `prompts/`, and `guides/` after useful review/QA/traceability patterns were distilled into operator-owned downstream guidance. Preserve `knowledge/` unless separately reviewed.
