...
| [skill-creation-architecture.md](research/skill-creation-architecture.md) | Agent Skills standard and skill creation architecture | 2026-02-14 | Aging | Valuable but contains known obsolete path conventions; update before using operationally. |
| [platform-agent-mechanics.md](research/platform-agent-mechanics.md) | Claude Code & local runner agent/subagent mechanics, context windows, cross-platform compatibility | 2026-02-15 | Aging | Valuable but runtime-specific; verify against installed OpenCode and current docs. |
